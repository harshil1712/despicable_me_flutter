...
class _CharacterDetailsScreenState extends State<CharacterDetailsScreen> with AfterLayoutMixin<CharacterDetailsScreen>{
            ...
            children: <Widget>[
              ...
              Align(
                  ...
                  child: Hero(
                      ...
                      child: Image.asset(widget.character.imgPath,
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(32.0, 0, 8, 16),
                child: Text(
                  widget.character.desc,
